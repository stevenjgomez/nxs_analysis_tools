...
def generate_gaussian(H, K, L, amp, stddev, lattice_params, coeffs: Incomplete | None = None): ...
...
class Interpolator:
    ...
    def generate_gaussian_kernel(self, amp, stddev, coeffs: Incomplete | None = None) -> None: ...
