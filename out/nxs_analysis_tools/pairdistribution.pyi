...
def generate_gaussian(H, K, L, amp, stddev, lattice_params, coeffs: Incomplete | None = None, center: Incomplete | None = None): ...
...
class Puncher:
    ...
    def generate_bragg_mask(self, punch_radius, coeffs: Incomplete | None = None, thresh: Incomplete | None = None): ...
    def generate_intensity_mask(self, thresh, radius, verbose: bool = True): ...
    def generate_mask_at_coord(self, coordinate, punch_radius, coeffs: Incomplete | None = None, thresh: Incomplete | None = None): ...
    def punch(self) -> None: ...

class Gaussian3DKernel(Kernel):
    def __init__(self, stddev, size, coeffs: Incomplete | None = None) -> None: ...
...
class Interpolator:
    ...
    def set_ellipsoidal_tukey_window(self, tukey_alpha: float = 1.0, coeffs: Incomplete | None = None) -> None: ...
