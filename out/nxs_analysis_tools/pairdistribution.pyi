...
class Symmetrizer2D(Symmetrizer):
    ...
    def symmetrize_2d(self, data=None, method: str = 'wedge', **kwargs): ...
    def symmetrize(self, data=None, method: str = 'wedge', **kwargs): ...

class Symmetrizer3D(Symmetrizer):
    def __init__(self, data=None) -> None: ...
    def symmetrize_3d(self, data=None, method: str = 'wedge', **kwargs): ...
    def symmetrize(self, data=None, method: str = 'wedge', **kwargs): ...
