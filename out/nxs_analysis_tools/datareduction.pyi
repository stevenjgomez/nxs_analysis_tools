...
def animate_slice_temp(temp_dependence, slice_obj, ax: Incomplete | None = None, interval: int = 500, save_gif: bool = False, filename: str = 'animation', title: bool = True, title_fmt: str = 'd', plot_slice_kwargs: Incomplete | None = None, ax_kwargs: Incomplete | None = None): ...
