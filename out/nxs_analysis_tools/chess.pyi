...
class TempDependence:
    ...
    def load_transforms(self, temperatures_list: Incomplete | None = None) -> None: ...
    def load_datasets(self, file_ending: str = 'hkli.nxs', temperatures_list: Incomplete | None = None) -> None: ...
