...
class TempDependence:
    ...
    def load_transforms(self, temperatures_list: Incomplete | None = None, print_tree: bool = True, use_nxlink: bool = False) -> None: ...
    def load_datasets(self, file_ending: str = 'hkli.nxs', temperatures_list: Incomplete | None = None, print_tree: bool = True) -> None: ...
    ...
    def overlay_fits(self, numpoints: Incomplete | None = None, vertical_offset: int = 0, cmap: str = 'viridis', ax: Incomplete | None = None) -> None: ...
    def fit_peak_simple(self) -> None: ...
    def plot_order_parameter(self, ax: Incomplete | None = None, **kwargs): ...
